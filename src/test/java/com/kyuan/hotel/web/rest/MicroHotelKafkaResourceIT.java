...
class MicroHotelKafkaResourceIT {
    ...
    void setup() {
        ...
        MicroHotelKafkaResource kafkaResource = new MicroHotelKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/micro-hotel-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/micro-hotel-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
