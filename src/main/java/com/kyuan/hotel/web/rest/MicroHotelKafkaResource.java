...
@RestController
@RequestMapping("/api/micro-hotel-kafka")
public class MicroHotelKafkaResource {
    private final Logger log = LoggerFactory.getLogger(MicroHotelKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public MicroHotelKafkaResource(KafkaProperties kafkaProperties) {
